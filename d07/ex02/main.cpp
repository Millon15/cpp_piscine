...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/27 16:57:42 by vbrazas           #+#    #+#             */
/*   Updated: 2018/06/27 17:31:09 by vbrazas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main( void )
{
	...
	std::cout << std::endl << "Content of first array: ";
	for ( uint i = 0; i < Ints1.size(); i++ ) {
		std::cout << Ints1[i] << std::endl;
	}
	std::cout << std::endl << std::endl << "Content of the second array: ";
