...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/27 14:14:21 by vbrazas           #+#    #+#             */
/*   Updated: 2018/06/27 14:57:25 by vbrazas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if		( *(reinterpret_cast<const Addr*>(a)) <  *(reinterpret_cast<const Addr*>(b)) )	return -1;
	else if	( *(reinterpret_cast<const Addr*>(a)) >  *(reinterpret_cast<const Addr*>(b)) )	return 1;
	return 0;
}
...
int			main( void )
{
	...
	std::cout << std::endl << "Array of floats:" << std::endl;
	iter<float>(floats, 10, &print<float>);



	std::cout << std::endl << std::endl << std::endl << "Sorting... ""Sorting... ""Sorting... ""Sorting... " << std::endl << std::endl << std::endl << std::endl;
